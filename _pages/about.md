...
Prof. Almquist has received two major honors from the American Sociological Association (ASA): The [Leo Goodman Award](https://www.asanet.org/communities-sections/sections/current-sections/methodology/methodology-award-recipient-history) from the Section on [Methodology](https://www.asanet.org/asa-communities/sections/methodology) and the [Outstanding Dissertation Award](http://www.asanet.org/sections/mathematical_past_recipients.cfm) from the Section on [Mathematical Sociology](http://www.asanet.org/asa-communities/sections/mathematical-sociology).
